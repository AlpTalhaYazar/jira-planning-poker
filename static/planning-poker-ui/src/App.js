...
export default function App() {
      ...
      children: [
        _jsxs("div", {
          ...
          children: [
            _jsx("p", {
              children:
                "Sessions are shared across your Jira site. Create one for each refinement or sprint planning meeting.",
            }),
            _jsxs("p", {
              children: [
                _jsx("strong", { children: "Project:" }),
                " ",
                projectName ?? "Unknown",
                " (",
                projectKey ?? "n/a",
            ...
            !projectConfig?.estimateFieldId &&
              _jsx("p", {
                ...
                children:
                  "Estimate field not configured. Apply-to-Jira will be disabled until you set one.",
              }),
          ],
        }),
        _jsxs("div", {
          ...
          children: [
            _jsxs("div", {
              className: "session-create-fields",
              children: [
                _jsx("label", {
            ...
            _jsx("button", {
              ...
              children: isCreatingSession ? "Creating…" : "Create session",
            }),
          ],
        }),
        sessionActionError &&
          _jsx("p", { className: "error-text", children: sessionActionError }),
        sessionsError &&
          _jsx("p", { className: "error-text", children: sessionsError }),
        isLoadingSessions
          ? _jsx("p", { children: "Loading sessions\u2026" })
          : sessions.length === 0
          ? _jsx("p", {
              children: "No sessions yet. Create one to get started.",
            })
          : _jsx("div", {
              className: "session-card-grid",
                    ...
                    children: [
                      _jsxs("header", {
                        children: [
                          _jsxs("p", {
                            className: "eyebrow",
                            children: ["Project ", session.projectKey],
                          }),
                          _jsx("h2", { children: session.name }),
                        ],
                      }),
                      _jsxs("p", { children: ["Deck: ", session.deckType] }),
                      _jsxs("p", {
                        children: [
                          "Created ",
        ...
        _jsxs("div", {
          className: "session-create-card",
          children: [
            _jsx("h3", { children: "Project configuration" }),
            configError &&
              _jsx("p", { className: "error-text", children: configError }),
            !projectConfig
              ? _jsx("p", { children: "Loading configuration\u2026" })
              ...
              : _jsxs(_Fragment, {
                  children: [
                    _jsxs("div", {
                      ...
                      children: [
                        _jsx("label", {
                          htmlFor: "estimate-field-id",
                          children: "Estimate Field ID",
                        }),
                        _jsx("input", {
                    ...
                    _jsx("button", {
                      ...
                      disabled:
                        ...
                        !projectConfig ||
                        !canEditProjectConfig,
                      children: isSavingConfig ? "Saving…" : "Save config",
                    }),
                  ],
                }),
          ],
  ...
  return _jsxs("div", {
    className: "app-shell",
    children: [
      showDebugToasts && _jsx(RealtimeDebugToasts, { events: debugEvents }),
      _jsx("header", {
        ...
        children: _jsxs("div", {
          children: [
            _jsx("p", {
              className: "eyebrow",
              children: "Jira Planning Poker",
            }),
            _jsx("h1", { children: pageTitle }),
          ],
        }),
      }),
      _jsxs("main", {
        ...
        children: [
          isLoadingContext &&
            _jsx("p", { children: "Loading Jira context\u2026" }),
          !isLoadingContext &&
            contextError &&
            _jsx("p", { className: "error-text", children: contextError }),
          !isLoadingContext &&
            !contextError &&
            !activeSession &&
            renderSessionList(),
