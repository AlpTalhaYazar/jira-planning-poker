...
export declare const leaveSession: (sessionId: string, accountId?: string) => Promise<void>;
...
export declare const updateSessionBacklog: (sessionId: string, issueKeys: string[], jql?: string) => Promise<unknown>;
export declare const getUserActiveSession: () => Promise<{
    sessionId: string | null;
}>;
export declare const startSession: (sessionId: string) => Promise<SessionSummary>;
export declare const toggleReady: (sessionId: string, isReady: boolean) => Promise<SessionSummary>;
