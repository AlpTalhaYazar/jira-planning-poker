...
export const leaveSession = async (sessionId, accountId) => {
...
export const updateSessionBacklog = async (sessionId, issueKeys, jql) => invoke("updateSessionBacklog", { sessionId, issueKeys, jql });
export const getUserActiveSession = async () => invoke("getUserActiveSession");
export const startSession = async (sessionId) => invoke("startSession", { sessionId });
export const toggleReady = async (sessionId, isReady) => invoke("toggleReady", { sessionId, isReady });
